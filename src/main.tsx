...
// so it is dead-code-eliminated from production builds (the `invoke` import is
// then tree-shaken too); the backing command exists only under the cargo `e2e`
// feature. Set synchronously so it is ready before the suite interacts.
