...
v0.1 手动测试中发现/提出的优化点，**不在本计划 T1–T18 范围内**，按路线图节奏在后续版本实现。权威规划见 `docs/ROADMAP.md`：
...
经批准后，本计划将另存为 `tasks/v0.1.0/plan.md`，并生成 `tasks/v0.1.0/todo.md` 任务清单（T1–T18 勾选项 + 5 个 checkpoint）。
